...
class AddMenuMasterComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            MenuId: 0,
                                ...
                                <Form.Group as={Row} controlId="formIsLeaf">
                                    ...
                                    <Col sm={1}>
                                        <Form.Control style={{ height: '20px', marginTop: '9px' }} type="checkbox" placeholder="IsLeaf"
                                            ...
                                            onChange={this.handleChange}
                                            value={this.state.IsLeaf ? 'false' : 'true'} />
                                ...
                                <Form.Group as={Row} controlId="formShowInMainMenu">
                                    ...
                                    <Col sm={1}>
                                        <Form.Control style={{ height: '20px', marginTop: '9px' }} type="checkbox" placeholder="Show In Main Menu"
                                            ...
                                            onChange={this.handleChange}
                                            value={this.state.ShowInMainMenu ? 'false' : 'true'} />
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(AddMenuMasterComponent)