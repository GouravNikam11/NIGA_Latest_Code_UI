...
class AddRoleDetailsComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            RecordId: 0,
                                ...
                                <Form.Group as={Row} controlId="formIsView">
                                    ...
                                    <Col sm={1}>
                                        <Form.Control style={{ height: '20px', marginTop: '9px' }} type="checkbox" placeholder="IsView"
                                            ...
                                            onChange={this.handleChange}
                                            value={this.state.IsView ? 'false' : 'true'} />
                                    </Col>
                                </Form.Group>
                            </Col>
                        </Row>
                                ...
                                <Form.Group as={Row} controlId="formIsAdd">
                                    ...
                                    <Col sm={1}>
                                        <Form.Control style={{ height: '20px', marginTop: '9px' }} type="checkbox" placeholder="IsAdd"
                                            ...
                                            onChange={this.handleChange}
                                            value={this.state.IsAdd ? 'false' : 'true'} />
                                ...
                                <Form.Group as={Row} controlId="formIsModify">
                                    ...
                                    <Col sm={1}>
                                        <Form.Control style={{ height: '20px', marginTop: '9px' }} type="checkbox" placeholder="IsAdd"
                                            ...
                                            onChange={this.handleChange}
                                            value={this.state.IsModify ? 'false' : 'true'} />
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(AddRoleDetailsComponent)