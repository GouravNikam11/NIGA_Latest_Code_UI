...
class AddBlogComponent extends Component {
    ...
    submitForm() {
        ...
        let obj={
            blogHead: this.state.blogHead,
            blogSubHead: this.state.blogSubHead,
            blogImage1: this.state.blogImage1,
            blogImage2:this.state.blogImage2,
            blogDetails1: this.state.blogDetails1,
            isActive: true,
            enteredBy: '',
            errors: {},
        ...
        CommonServices.postData(obj, `/BlogDetail`).then((responseMessage) => {
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(AddBlogComponent)