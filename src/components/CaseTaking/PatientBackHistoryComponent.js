...
import { Badge, Card, CardBody, CardHeader, Input, Col, PaginationItem, PaginationLink, Row, Table } from 'reactstrap';
 ...
 */
class PatientBackHistoryComponent extends Component {
    //Constructor.
    constructor(props) {
        super(props);
        this.state = {
    ...
    handlegetrubricbyPatientAppid = (s) => {
        ...
        CommonServices.getDataByIdmonogram(s.patientAppId, `/Prescription/PrescriptionRubricDetail?appointmentId=`).then((res) => {
            ...
            debugger
            console.log("after set from api this.props.state.selectedRubrics", this.props.state.selectedRubrics)
...
export default connect(mapStateToProps, mapDispatchToProps)(PatientBackHistoryComponent);