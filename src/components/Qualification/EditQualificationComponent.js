...
class EditQualificationComponent extends Component {
    constructor(props) {
        super(props)
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(EditQualificationComponent)
