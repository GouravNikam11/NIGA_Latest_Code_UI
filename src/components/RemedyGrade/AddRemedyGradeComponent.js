...
class AddRemedyGradeComponent extends Component {
    constructor(props) {
        super(props)
                ...
                <CardBody>
                    <Form encType="multipart/form-data" className="form-horizontal">
                        <Row>
                            <Col xs="12" md="4">
                                <FormGroup >
                                    <Label className="label" htmlFor="">Remedy Grade No <span className="required">*</span> :</Label>
                                    <Form.Control type="text" placeholder="Remedy Grade No"
                                        name="GradeNo"
                                        onChange={this.handleChange}
                                        value={this.state.GradeNo === null ? '' : this.state.GradeNo} />
                                    <span className="error">{this.state.errors["GradeNo"]}</span>
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(AddRemedyGradeComponent)
