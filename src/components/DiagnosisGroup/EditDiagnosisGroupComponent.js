...
class EditDiagnosisGroupComponent extends Component {
    /**
    ...
    componentDidMount() {
        ...
        this.editDiagnosisGroup(this.props.match.params.id);
    }
    render() {
        return (
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(EditDiagnosisGroupComponent)