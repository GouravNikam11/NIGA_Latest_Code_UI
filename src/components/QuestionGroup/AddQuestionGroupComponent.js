...
class AddQuestionGroupComponent extends Component {
    constructor(props) {
        super(props)
                            ...
                            <Col xs="12" md="4">
                                <FormGroup >
                                    ...
                                    <Form.Control as="select"
                                        ...
                                        value={this.state.questionSectionId}>
                                        <option value="0">
                                            Select Existance Name
                                        </option>
                                        {
    ...
    validateForm() {
        ...
        if (fields.questionSectionId == "") {
            isFormValid = false;
            errors["questionSectionId"] = "Please select existance name "
        }
...
export default connect(null, { enqueueSnackbarAction, closeSnackbar })(AddQuestionGroupComponent)
